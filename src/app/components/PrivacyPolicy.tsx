        ...
        <div className="space-y-8 text-[var(--github-text-secondary)] leading-relaxed">
          ...
          <section>
            ...
            <div className="mt-4 p-4 rounded-lg border border-[var(--github-border-primary)] bg-[var(--github-border-secondary)]">
              ...
              <p className="text-sm">
                En Belgique, l'âge du consentement numérique est fixé à <strong className="text-[var(--github-text-primary)]">13 ans</strong>. En dessous de cet âge, <strong className="text-[var(--github-text-primary)]">nous ne créons pas de compte</strong> : un écran demande ta date de naissance avant toute inscription, et l'inscription est refusée sous 13 ans. Cette date est vérifiée dans ton navigateur et n'est jamais transmise à nos serveurs. Si l'inscription est acceptée, seule la date à laquelle cet écran a été validé est enregistrée avec ton compte. Si elle est refusée, ton navigateur garde uniquement, sur ton appareil, la date à partir de laquelle elle redeviendra possible, et l'efface dès ta première visite à partir de ce jour-là. L'usage anonyme reste accessible sans condition d'âge et donne accès à la totalité des leçons.
              </p>
            </div>
          </section>
