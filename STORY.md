...
### Ce sur quoi on travaille maintenant (avril 2026)

**Module 11 — L'IA comme outil dev (THI-29)**
Le dernier module du curriculum de base. Comment utiliser l'IA dans un workflow de développement réel — pas comme oracle, comme outil.
...
**Page `/changelog` et `/story` (THI-84)**
Ce que vous êtes en train de lire existe en fichier Markdown. La prochaine étape : en faire des pages dans l'app, accessibles depuis le footer, avec un design narratif cohérent.
...
L'app est en français. L'anglais et le néerlandais sont dans la roadmap. La question n'est pas technique — c'est une question de contenu. Traduire 52 leçons et 876 validations de commandes demande une attention pédagogique qu'on ne peut pas expédier.
