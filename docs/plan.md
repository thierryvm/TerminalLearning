...
| THI-91 | tech-debt | **Umbrella shadcn migration** — seule source de vérité pour le scope restant. Landing A/B/C ✅ (PR #118, #124, #125) + Dashboard ✅ (enfant **THI-95**, PR #131, 17 avril 2026). Reste : LessonPage, ChangelogPage, StoryPage, CommandReference 🔄 In Progress |
