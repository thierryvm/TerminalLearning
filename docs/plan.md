...
> Dernière mise à jour : 5 mai 2026 après-midi UTC+1 — Phase 7c THI-152 sprint mobile recovery EN COURS (5/9 mini-PRs livrées : focus traps a11y + forms anti-zoom + FAB Sparkles size/opacity/position + PWA apple-touch-icon PNG + touch targets ≥44/≤40 ; reste 4 mini-PRs : chat bubble word-break, focus rings emerald harmonization, safe-area top bar + autoFocus terminal, theme-color media + W3C mobile-web-app-capable). THI-150 ✅ + THI-151 ✅ + 5 sub-PRs THI-152 (#196/#197/#198/#199/#200 en cours) toutes mergées sauf #200. Empirical override mini-PR 3/9 confirmé par @thierry (FAB mobile 48→44 px, desktop 56 inchangé, asymétrie intentionnelle primary action exemption).
