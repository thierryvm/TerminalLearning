...
> Dernière mise à jour : 5 mai 2026 soirée UTC+1 — Phase 7c THI-152 sprint mobile recovery EN COURS (7/9 mini-PRs livrées : focus traps a11y + forms anti-zoom + FAB Sparkles size/opacity/position + PWA apple-touch-icon PNG + touch targets ≥44/≤40 + drawer overflow word-break + PWA safe-area top + autoFocus terminal contrôlé ; reste 2 mini-PRs : focus rings emerald harmonization (8/9 renumérotée), theme-color media + W3C mobile-web-app-capable (9/9)). **Promotion 7/9 → 8/9 décidée @cowork** : safe-area P0 visible (bug PWA standalone @thierry) priorisé sur focus rings P1 cosmétique. THI-150 ✅ + THI-151 ✅ + 5 sub-PRs THI-152 (#196/#197/#198/#199/#200 en cours) toutes mergées sauf #200. Empirical override mini-PR 3/9 confirmé par @thierry (FAB mobile 48→44 px, desktop 56 inchangé, asymétrie intentionnelle primary action exemption).
